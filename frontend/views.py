...
def view_client_dashboard(request):
    ...
    # Check if user has completed medical questionnaire
    has_medical_questionnaire = False
    if request.user.is_authenticated:
        medical_questionnaire = MedicalQuestionnaire.objects.filter(user=request.user).first()
        has_medical_questionnaire = medical_questionnaire is not None and all([
            medical_questionnaire.physician_care is not None,
            medical_questionnaire.high_blood_pressure is not None,
            medical_questionnaire.heart_disease is not None,
            medical_questionnaire.allergic is not None,
            medical_questionnaire.diabetes is not None,
            medical_questionnaire.blood_disease is not None,
            medical_questionnaire.bleeder is not None,
            medical_questionnaire.excessive_bleeding is not None,
            medical_questionnaire.recent_infection is not None,
            medical_questionnaire.anesthetic_reactions is not None,
            medical_questionnaire.previous_dental_surgery is not None,
            medical_questionnaire.health_impression is not None,
        ])
    ...
    medical_questions = [
        ...
        {'text': 'Have you or have you recently had evidence of infection such as boils, infected wounds?', 'type': 'yes_no'},
    ...
    context = {
        ...
        'has_medical_questionnaire': has_medical_questionnaire,
    }
